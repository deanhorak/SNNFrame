...
CONFIG_PATH="${CONFIG_PATH:-${ROOT_DIR}/configs/emnist_retina_bilateral_continuous.sonata.json}"
...
LOG_PATH="${LOG_PATH:-${BUILD_DIR}/emnist_retina_bilateral_continuous.log}"

CMD=(
  "${BUILD_DIR}/experiments/emnist_retina_letters"
  --config "${CONFIG_PATH}"
